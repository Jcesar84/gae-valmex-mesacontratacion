              ...
              <TableBody>
                <TableRow>
                  <TableCell align="left">
                    <FormControl>
                      <FormLabel id="revisionDomicilios">Revisión</FormLabel>
                      <RadioGroup
                        aria-labelledby="revisionDomicilios"
                  ...
                  <TableCell align="left">
                    <List>
                      <ListItem disablePadding>
                          <ListItemText primary="Dirección Particular" />
                          <ListItemIcon>
                            <Estatus label={""} estatusMostrar={'si-img'} />
                          </ListItemIcon>
                      </ListItem>
                      <ListItem disablePadding>
                          <ListItemText primary="Dirección Fiscal" />
                          <ListItemIcon>
                            <Estatus label={""} estatusMostrar={'si-img'} />
                          </ListItemIcon>
                      </ListItem>
